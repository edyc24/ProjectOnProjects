-- =====================================================
-- Script de creare a tabelelor pentru MoneyShop
-- Oracle Database 19c+
-- =====================================================
...
CREATE TABLE UTILIZATORI (
    ...
    Parola VARCHAR2(255) NOT NULL, -- Hash SHA-256
...
CREATE TABLE APLICATII (
    ...
    ListaBanciActive CLOB, -- JSON array
    NrIfn NUMBER,
    Poprire NUMBER(1),
    SoldTotal NUMBER(18,2),
    Intarzieri NUMBER(1),
    IntarzieriNumar NUMBER,
    CardCredit CLOB, -- JSON array
    Overdraft CLOB, -- JSON array
    Codebitori CLOB, -- JSON array
    Scoring NUMBER(5,2),
    Dti NUMBER(5,2),
...
CREATE TABLE DOCUMENTE (
    ...
    Path VARCHAR2(1000) NOT NULL, -- Criptat
...
-- Tabela MESAJE (cerință proiect SBD)
CREATE TABLE MESAJE (
...
-- =====================================================
-- 2. Crearea indexurilor pentru performanță
-- =====================================================
...
-- =====================================================
-- 4. Crearea trigger-urilor pentru UpdatedAt și validare vârstă
-- =====================================================
