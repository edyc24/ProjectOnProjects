-- =====================================================
-- TESTARE PROCEDURI PL/SQL
-- =====================================================

SET SERVEROUTPUT ON;

-- Test 1: Găsește un utilizator cu date și testează procedura cu colecții
DECLARE
...
BEGIN
    ...
    -- Găsește un utilizator cu aplicații
    BEGIN
...
-- Test 2: Testează procedura cu cursoare
DECLARE
    v_id_rol NUMBER;
    v_rezultat VARCHAR2(500);
BEGIN
...
-- Test 3: Testează funcția cu excepții
DECLARE
    v_id_utilizator NUMBER;
...
BEGIN
    ...
    -- Test cu utilizator inexistent (pentru a testa excepția)
    DBMS_OUTPUT.PUT_LINE('');
...
-- Test 4: Verificare mesaje în MESAJE
BEGIN
    DBMS_OUTPUT.PUT_LINE('');
    DBMS_OUTPUT.PUT_LINE('========================================');
